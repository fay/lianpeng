...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FeedCount'
        db.create_table('bookmark_feedcount', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('last_id', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('updated_time', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('bookmark', ['FeedCount'])


    def backwards(self, orm):
        # Deleting model 'FeedCount'
        db.delete_table('bookmark_feedcount')
    ...
    models = {
        ...
        'bookmark.feedcount': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_id': ('django.db.models.fields.PositiveIntegerField', [], {}),
