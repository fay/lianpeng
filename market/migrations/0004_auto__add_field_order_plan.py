...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('market_order', 'plan',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['market.AppPlan']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.plan'
        db.delete_column('market_order', 'plan_id')
