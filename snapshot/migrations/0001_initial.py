...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('snapshot_snapshot', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('bookmark', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bookmark.Bookmark'])),
            ('html_file', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
            ('created_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('snapshot', ['Snapshot'])


    def backwards(self, orm):
        # Deleting model 'Snapshot'
        db.delete_table('snapshot_snapshot')
    ...
    models = {
        ...
        'snapshot.snapshot': {
            ...
            'bookmark': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['bookmark.Bookmark']"}),
