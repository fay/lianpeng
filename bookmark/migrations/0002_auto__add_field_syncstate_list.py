...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SyncState.list'
        db.add_column('bookmark_syncstate', 'list',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bookmark.List'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SyncState.list'
        db.delete_column('bookmark_syncstate', 'list_id')
